...
const screenLayers = {
    ...
    'route-selection-screen': [shuttleRoutePolyline, userLocationMarker, pinMarker, walkingETAMarker, busETAMarker, walkingRoutePolylineOutline2, walkingRoutePolylineOutline1, walkingRoutePolylineFill,  busRoutePolylineOutline1, busRoutePolylineOutline2, busRoutePolylineFill, shuttleMarker],
    'navigation-screen': [userLocationMarker, shuttleRoutePolyline, busRouteOutline, busRouteFill, pathToStopAOutline, pathToStopAFill, pathToALCOutline, pathToALCFill, busStopAMarker, busStopBMarker, pinMarker, shuttleMarker]
};
